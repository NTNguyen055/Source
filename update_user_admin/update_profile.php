...
if (isset($_POST['update_profile'])) {
    ...
    if (!empty($update_pass) || !empty($new_pass) || !empty($confirm_pass)) {
        if (($old_pass != $update_pass) && !empty($update_pass)) {
    ...
    if (!empty($update_image)) {
        ...
        if ($update_image_size > 2000000) {
            ...
            $update_image_query = mysqli_query($conn, "UPDATE `user_form` SET image = '$update_image' WHERE id = '$user_id'")
                or die('query failed');
...
<body>
    ...
    <div class="update_profile">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <a href="../dashboard/inforBookAndOrder.php" class="btn">Thông tin bàn đặt và biên lai</a>
            <a href="../dashboard/Trangchu.php" class="delete-btn">Trang chủ</a>
