...
if (!empty($sxField) && !empty($sxSort)) {
    $sxCondition = "ORDER BY `booking`.`" . $sxField . "` " . $sxSort;
...
if ($search) {
    $selectMain = mysqli_query($conn, "SELECT * FROM `booking` WHERE `name` LIKE '%" . $search . "%' " . $sxCondition . " LIMIT " . $per_page . " OFFSET " . $offset) or die('query failed');
    $totalPro = mysqli_query($conn, "SELECT * FROM `booking` WHERE `name` LIKE '%" . $search . "%'");
} else {
    $selectMain = mysqli_query($conn, "SELECT * FROM `booking` " . $sxCondition . " LIMIT " . $per_page . " OFFSET " . $offset) or die('query failed');
    $totalPro = mysqli_query($conn, "SELECT * FROM `booking`");
}
...
if (isset($_GET['capNhat'])) {
    ...
    $result = "Đã chốt đơn";
    mysqli_query($conn, "UPDATE `booking` SET result = '$result' WHERE id = '$capNhat_id'") or die('query failed');
                            ...
                            ?>
                                    <div class="content-box-pro-main">
                                        ...
                                        <div class="content-box-pro-5 bcbp-4">
                                            <div class="cbp-content">
                                                <span><?php echo $fetch['hour']; ?></span>
                                            </div>
                                        </div>
                                        <div class="content-box-pro-8 bcbp-5">
                                            <div class="cbp-content">
                                                <span><?php echo $fetch['day']; ?></span>
                                            </div>
                                        </div>
                                        <div class="content-box-pro-7 bcbp-8">
                                            <div class="cbp-content">
                                                <span><?php echo $fetch['person']; ?></span>
                                            </div>
                                        </div>
                                        <div class="content-box-pro-10 bcbp-7">
                                            <div class="cbp-content">
                                                ...
                                                {
                                                    echo "<a href='booking.php?capNhat=".$fetch['id']."'>".$fetch['result']."</a>";
                                                }
                                                else {
                                        ...
                                        <div class="content-box-pro-6 bcbp-9">
                                            <div class="cbp-content">
                                                <a href="booking.php?remove=<?php echo $fetch['id']; ?>" onclick="return confirm('Bạn muốn hủy đơn đặt bàn này?')">Hủy</a>
                                            </div>
                                        </div>
                                    </div>
                            <?php
