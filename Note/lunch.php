                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="sec-title text-center mb-5">
                                    <p class="sec-sub-title mb-3">Menu ăn trưa Của ND</p>
                        ...
                        <div class="menu-list-row">
                            <div class="row g-xxl-5 bydefault_show" id="menu-dish">
                                ...
                                <?php
                                $select_product = mysqli_query($conn, "SELECT * FROM `trua`") or die('query failed');
