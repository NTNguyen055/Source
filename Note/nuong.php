                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="sec-title text-center mb-5">
                                    <p class="sec-sub-title mb-3">Menu Nướng Tại Gia Của ND</p>
                        ...
                        <div class="menu-list-row">
                            <div class="row g-xxl-5 bydefault_show" id="menu-dish">
                                ...
                                <?php
                                $select_product = mysqli_query($conn, "SELECT * FROM `nuong`") or die('query failed');

                                if (mysqli_num_rows($select_product) > 0) {
                                    while ($fetch_product = mysqli_fetch_assoc($select_product)) {
                                ?>

                                        <div class="col-lg-3 col-sm-6 dish-box-wp ">

                                            <form action="" method="post" class="box-product">
                                                <div class="dish-box text-center">
                                                    <div class="dist-img">
                                                        <img src="assets/images/dish/<?php echo $fetch_product['image']; ?>" alt="" width="180px" height="180px">
                                                    </div>
                                                    ...
                                                    <div class="dish-title">
                                                        <h5 class="h3-title"><?php echo $fetch_product['name']; ?></h5>
                                                    </div>
                                                    ...
                                                    <div class="tuyChon">
                                                        <!-- <a href="" class="xemThemSP">Chi tiết</a>
                                                        <input type="submit" value="Thêm vào giỏ hàng" name="add_to_cart" class="btn-pro"> -->
                                                    </div>
