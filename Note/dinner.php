                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="sec-title text-center mb-5">
                                    <p class="sec-sub-title mb-3">Menu ăn tối Của ND</p>
                        ...
                        <div class="menu-list-row">
                            <div class="row g-xxl-5 bydefault_show" id="menu-dish">
                                ...
                                <?php
                                $select_product = mysqli_query($conn, "SELECT * FROM `toi`") or die('query failed');
                                            ...
                                            <form action="" method="post" class="box-product">
                                                <div class="dish-box text-center">
                                                    ...
                                                    <div class="dist-bottom-row">
                                                        <ul>
                                                            <li>
                                                                <b>Giá cả: <?php echo $fetch_product['price']; ?>K</b>
                                                            </li>
                                                            <li>
                                                    ...
                                                    <input type="submit" value="Thêm vào giỏ hàng" name="add_to_cart" class="btn-user">
